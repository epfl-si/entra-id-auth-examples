...
builder.Services.AddAuthentication(MS_OIDC_SCHEME)
    .AddOpenIdConnect(MS_OIDC_SCHEME, oidcOptions =>
    {
        ...
        oidcOptions.Authority = "https://login.microsoftonline.com/"+ Environment.GetEnvironmentVariable("OIDC_TENANT_ID") +"/v2.0/";
        // ........................................................................
        ...
        oidcOptions.ClientId = Environment.GetEnvironmentVariable("OIDC_CLIENT_ID");
        // ........................................................................
